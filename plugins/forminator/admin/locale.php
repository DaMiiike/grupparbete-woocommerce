...
"Settings" => array( null, __("Settings", "forminator" ), ), // src/form/components/behaviour.js:143
"Email Notifications" => array( null, __("Email Notifications", "forminator" ), ), // src/form/components/behaviour.js:152
...
"Save and Continue" => array( null, __("Save and Continue", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:38
"Your {form_name} form on {site_title} has been saved as draft" => array( null, __("Your {form_name} form on {site_title} has been saved as draft", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:39
...
To continue where you left off, click the link below or copy the link to your web browser.</p><p><a href='{form_link}' target='_blank' rel='noopener noreferrer' style='color:#17A8E3;'>{form_link}</a></p><p>The above link will expire in {retention_period} days. Also note that anyone visiting the link will be able to view your partially completed form data.</p>", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:40
"<p>Your form has been saved as draft and a resume link has been generated so you can return to the form anytime within {retention_period} days from today. Copy and save the link or enter your email address below to have the link sent to your mail.</p><p>These fields weren't saved to your submission draft: Paypal, Stripe, Signature, Password, Captcha, and Upload. Kindly fill them out before submitting the form.</p>" => array( null, __("<p>Your form has been saved as draft and a resume link has been generated so you can return to the form anytime within {retention_period} days from today. Copy and save the link or enter your email address below to have the link sent to your mail.</p><p>These fields weren't saved to your submission draft: Paypal, Stripe, Signature, Password, Captcha, and Upload. Kindly fill them out before submitting the form.</p>", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:72
"Enable this option if you want to allow users save their progress and return to complete the form at a later time." => array( null, __("Enable this option if you want to allow users save their progress and return to complete the form at a later time.", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:95
"Enable save and continue" => array( null, __("Enable save and continue", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:107
"Configuration" => array( null, __("Configuration", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:125
"Draft retention period" => array( null, __("Draft retention period", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:131
"Enter the number of days a form's draft will be stored on your server before they are automatically deleted." => array( null, __("Enter the number of days a form's draft will be stored on your server before they are automatically deleted.", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:133
"Save form link text" => array( null, __("Save form link text", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:143
"Save as Draft" => array( null, __("Save as Draft", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:144
"Edit text for the save draft link." => array( null, __("Edit text for the save draft link.", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:145
"Resume message" => array( null, __("Resume message", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:155
"This message will be shown when a form is successfully saved as draft." => array( null, __("This message will be shown when a form is successfully saved as draft.", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:156
"These fields will not be saved in the submission draft: Paypal, Stripe, Signature, Password, Captcha, and Upload." => array( null, __("These fields will not be saved in the submission draft: Paypal, Stripe, Signature, Password, Captcha, and Upload.", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:172
"Allow send draft link to email" => array( null, __("Allow send draft link to email", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:183
"Enable to allow users send the draft form's link to their email." => array( null, __("Enable to allow users send the draft form's link to their email.", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:184
"Configure the send link email form below. You can edit the email contents in the {{link}}Email Notifications{{/link}} tab." => array( null, __("Configure the send link email form below. You can edit the email contents in the {{link}}Email Notifications{{/link}} tab.", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:195
"Email input label" => array( null, __("Email input label", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:211
"Send draft link to" => array( null, __("Send draft link to", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:212
"Placeholder (Optional)" => array( null, __("Placeholder (Optional)", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:218
"E.g., johndoe@gmail.com" => array( null, __("E.g., johndoe@gmail.com", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:219
"Send link button label" => array( null, __("Send link button label", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:225
"Send draft link" => array( null, __("Send draft link", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:226
"Permission" => array( null, __("Permission", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:237
"Select which users can save their forms as draft." => array( null, __("Select which users can save their forms as draft.", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:242
"Public" => array( null, __("Public", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:258
"Every user can save their forms as draft." => array( null, __("Every user can save their forms as draft.", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:262
"Registered Users" => array( null, __("Registered Users", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:272
"Only registered users can save their forms as draft." => array( null, __("Only registered users can save their forms as draft.", "forminator" ), ), // src/form/components/behaviour/save-and-continue.js:276
...
"Try Pro for 10% Off" => array( null, __("Try Pro for 10% Off", "forminator" ), ), // src/form/components/fields/stripe/addon-required.js:61
...
"Apply" => array( null, __("Apply", "forminator" ), ), // src/form/components/modals/behavior.js:409
...
"Delete Field" => array( null, __("Delete Field", "forminator" ), ), // src/form/components/modals/delete.js:134
"Deleting this field {%(name)s} will also remove associated values from existing submissions." => array( null, __("Deleting this field {%(name)s} will also remove associated values from existing submissions.", "forminator" ), ), // src/form/components/modals/delete.js:142
"Note that this field is mapped in {{link}}Default Meta Keys{{/link}}. If deleted, you will need to remap meta keys {{link}}here{{/link}}." => array( null, __("Note that this field is mapped in {{link}}Default Meta Keys{{/link}}. If deleted, you will need to remap meta keys {{link}}here{{/link}}.", "forminator" ), ), // src/form/components/modals/delete.js:155
"Please remove the references to this field from the following form fields first." => array( null, __("Please remove the references to this field from the following form fields first.", "forminator" ), ), // src/form/components/modals/delete.js:244
"Form Fields" => array( null, __("Form Fields", "forminator" ), ), // src/form/components/modals/delete.js:256
"Got It" => array( null, __("Got It", "forminator" ), ), // src/form/components/modals/delete.js:270
...
"Warning! You've added more than 1000 options. Switching back to the standard (non-bulk) editor could make your browser slow or unresponsive. Proceed with caution." => array( null, __("Warning! You've added more than 1000 options. Switching back to the standard (non-bulk) editor could make your browser slow or unresponsive. Proceed with caution.", "forminator" ), ), // src/form/components/settings/multi-value.js:634
"Options" => array( null, __("Options", "forminator" ), ), // src/form/components/settings/multi-value.js:651
"Enable Images" => array( null, __("Enable Images", "forminator" ), ), // src/form/components/settings/multi-value.js:668
"Bulk Edit" => array( null, __("Bulk Edit", "forminator" ), ), // src/form/components/settings/multi-value.js:678
"Loading" => array( null, __("Loading", "forminator" ), ), // src/form/components/settings/multi-value.js:689
"Add Option" => array( null, __("Add Option", "forminator" ), ), // src/form/components/settings/multi-value.js:716
"Enter field options (one per line)" => array( null, __("Enter field options (one per line)", "forminator" ), ), // src/form/components/settings/multi-value.js:733
"Type or paste options above (one per line and separated by semicolons) or click 
 ...
 {{b}}\"+ Predefined options\"{{/b}} link to select an option. Example: {{b}}false{{/b}}", "forminator" ), ), // src/form/components/settings/multi-value.js:735
"Import options from CSV" => array( null, __("Import options from CSV", "forminator" ), ), // src/form/components/settings/multi-value.js:751
"Upload file" => array( null, __("Upload file", "forminator" ), ), // src/form/components/settings/multi-value.js:759
"Import" => array( null, __("Import", "forminator" ), ), // src/form/components/settings/multi-value.js:774
"Choose a CSV (.csv) file to import field options and values." => array( null, __("Choose a CSV (.csv) file to import field options and values.", "forminator" ), ), // src/form/components/settings/multi-value.js:800
"Download csv template" => array( null, __("Download csv template", "forminator" ), ), // src/form/components/settings/multi-value.js:803
