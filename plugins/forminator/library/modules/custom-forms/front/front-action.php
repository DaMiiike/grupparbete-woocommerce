...
class Forminator_CForm_Front_Action extends Forminator_Front_Action {
	 ...
	 * @param array $field_settings Field settings.
	 */
	private static function proceed_to_upload() {
		...
		foreach ( $fields as $key => $field ) {
			...
			if ( 'multiple' === $file_type && 'ajax' === $upload_method ) {
				...
				$upload_data      = $form_field_obj->handle_submission_multifile_upload( $field_settings, $form_upload_data );
			} else {
